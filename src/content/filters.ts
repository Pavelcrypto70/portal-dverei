...
export const hardwareFacets: FacetDef[] = [
  ...
  stockFacet,
  {
    ...
    options: [
      all,
      { value: "round_rosette", label: "Ручки на круглой розетке" },
      { value: "square_rosette", label: "Ручки на квадратной розетке" },
      { value: "sliding_handles", label: "Ручки для раздвижных дверей" },
      { value: "card_hinges", label: "Петли карточные" },
      { value: "butterfly_hinges", label: "Петли бабочки" },
      { value: "concealed_hinges", label: "Петли скрытые" },
      { value: "magnetic_latches", label: "Магнитные защелки" },
      { value: "concealed_stops", label: "Скрытые ограничители" },
      { value: "auto_thresholds", label: "Автоматические пороги" },
    ],
  },
  {
    key: "color",
    ...
    options: [
      all,
      { value: "matte_gold", label: "Матовое золото" },
      { value: "gloss_gold", label: "Глянцевое золото" },
      { value: "black", label: "Черный" },
      { value: "matte_chrome", label: "Матовый хром" },
      { value: "gloss_chrome", label: "Глянцевый хром" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "morelli", label: "Morelli" },
      { value: "fuaro", label: "Fuaro" },
      { value: "punto", label: "Punto" },
      { value: "rucetti", label: "Rucetti" },
