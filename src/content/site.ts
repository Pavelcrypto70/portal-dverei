    ...
    columns: [
      {
        title: "Ручки",
        links: [
          { label: "На круглой розетке", href: "/catalog/hardware?cat=round_rosette" },
          { label: "На квадратной розетке", href: "/catalog/hardware?cat=square_rosette" },
          { label: "Для раздвижных", href: "/catalog/hardware?cat=sliding_handles" },
        ],
      },
      {
        title: "Петли и фурнитура",
        links: [
          { label: "Петли карточные", href: "/catalog/hardware?cat=card_hinges" },
          { label: "Петли бабочки", href: "/catalog/hardware?cat=butterfly_hinges" },
          { label: "Петли скрытые", href: "/catalog/hardware?cat=concealed_hinges" },
          { label: "Магнитные защелки", href: "/catalog/hardware?cat=magnetic_latches" },
          { label: "Автоматические пороги", href: "/catalog/hardware?cat=auto_thresholds" },
        ],
      },
    ],
  },
...
export const products: Product[] = [
  ...
  {
    id: "lock",
    slug: "petlya-butterfly",
    category: "hardware",
    name: "Петля-бабочка Invisible",
    price: 1290,
    finish: "Черный",
    style: "Петли бабочки",
    short: "Скрытый монтаж без врезки — удобно для лёгких межкомнатных полотен.",
    filters: {
      cat: "butterfly_hinges",
      color: "black",
      brand: "fuaro",
      stock: "in_stock",
    },
    kit: { leaf: 1290, frame: 0, casings: 0, hardwareBase: 0 },
  },
